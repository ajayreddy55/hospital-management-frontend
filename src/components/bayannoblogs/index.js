...
const BayannoBlogsPage = () => {
  return (
    <div className="bayanno-blogs-bg-container">
      <div className="bayanno-blogs-inner-bg-container">
        <Navbar />
        <div className="bayanno-blogs-content-container">
          <section className="bayanno-common-home-heading-container">
            <div className="container">
              <div className="row">
                <div className="col-12">
                  <h1 className="bayanno-common-home-heading">BLOG</h1>
          ...
          <section className="bayanno-blogs-main-section">
            <div className="container">
              <div className="row">
                {blogsList.map((eachObject) => (
                  <div
                    key={eachObject.id}
                    className="col-12 col-md-4 mt-2 mb-2 h-100"
                  >
                    <div className="bayanno-blogs-card mr-3 mt-2 mb-2">
                      <div className="d-flex flex-column p-3">
                        <h3 className="bayanno-blogs-card-heading">
                          {eachObject.title}
                        </h3>
                        <p className="bayanno-blogs-card-text">
                          {eachObject.description}
                        </p>
                      </div>
                      <hr className="bayanno-blogs-card-hr-line" />
                      <div className="d-flex align-items-center justify-content-between p-3">
                        <div className="bayanno-blogs-card-date-container">
                          <i class="fa-regular fa-calendar-days mr-2 mb-2"></i>
                          <span className="mb-2">{eachObject.date}</span>
                        </div>
                        <Link
                          className="bayanno-blogs-card-read-more-container"
                          to={`/bayanno/home/blogs-details/${eachObject.id}`}
                        >
                          <i class="fa-solid fa-arrow-right mr-2 mb-2"></i>
                          <span className="mb-2">Read More</span>
                        </Link>
                      </div>
                    </div>
                  </div>
...
export default BayannoBlogsPage;
