...
const PharmacistPageRows = (props) => {
  const { eachObject, gettingPharmacistsList } = props;
  const { name, email, address, phoneNumber, profileImage, _id } = eachObject;

  const getListAgain = () => {
    gettingPharmacistsList();
  };
  ...
  const submitEditedInputs = async (iconImage) => {
    const url = `http://localhost:5000/api/modify-pharmacist/${_id}`;
  ...
  const deleteDetailsFromServer = async () => {
    const url = `http://localhost:5000/api/delete-pharmacist/${_id}`;
    const jwtToken = Cookies.get("hospital-jwt-token");
    const options = {
      method: "DELETE",
      headers: {
                ...
                >
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      ...
                      htmlFor="editPharmacistNameInput"
                    >
                      Name
                    </label>
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editPharmacistEmailInput"
                    >
                      Email
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editPharmacistAddressInput"
                    >
                      Address
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editPharmacistPhoneInput"
                    >
                      Phone
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                  ...
                  <div className="text-md-center mt-2 mb-2">
                    {editIcon.icon === "" ? (
                      <label
                        ...
                        htmlFor="editPharmacistIconInput"
                      >
                        Select Image
                      </label>
                    ) : (
...
export default PharmacistPageRows;
