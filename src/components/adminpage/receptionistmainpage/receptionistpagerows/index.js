...
const ReceptionistPageRows = (props) => {
  const { eachObject, gettingReceptionistsList } = props;
  const { name, email, address, phoneNumber, profileImage, _id } = eachObject;

  const getListAgain = () => {
    gettingReceptionistsList();
  };
  ...
  const submitEditedInputs = async (iconImage) => {
    const url = `http://localhost:5000/api/modify-receptionist/${_id}`;
  ...
  const deleteDetailsFromServer = async () => {
    const url = `http://localhost:5000/api/delete-receptionist/${_id}`;
    const jwtToken = Cookies.get("hospital-jwt-token");
    const options = {
      method: "DELETE",
      headers: {
                ...
                >
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      ...
                      htmlFor="editReceptionistNameInput"
                    >
                      Name
                    </label>
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editReceptionistEmailInput"
                    >
                      Email
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editReceptionistAddressInput"
                    >
                      Address
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                      <textarea
                        ...
                        id="editReceptionistAddressInput"
                        rows={20}
                        cols={60}
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editReceptionistPhoneInput"
                    >
                      Phone
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                  ...
                  <div className="text-md-center mt-2 mb-2">
                    {editIcon.icon === "" ? (
                      <label
                        ...
                        htmlFor="editReceptionistIconInput"
                      >
                        Select Image
                      </label>
                    ) : (
...
export default ReceptionistPageRows;
