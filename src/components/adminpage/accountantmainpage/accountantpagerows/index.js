...
const AccountantPageRows = (props) => {
  const { eachObject, gettingAccountantsList } = props;
  const { name, email, address, phoneNumber, profileImage, _id } = eachObject;

  const getListAgain = () => {
    gettingAccountantsList();
  };
  ...
  const submitEditedInputs = async (iconImage) => {
    const url = `http://localhost:5000/api/modify-accountant/${_id}`;
  ...
  const deleteDetailsFromServer = async () => {
    const url = `http://localhost:5000/api/delete-accountant/${_id}`;
    const jwtToken = Cookies.get("hospital-jwt-token");
    const options = {
      method: "DELETE",
      headers: {
                ...
                >
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      ...
                      htmlFor="editAccountantNameInput"
                    >
                      Name
                    </label>
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editAccountantEmailInput"
                    >
                      Email
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editAccountantAddressInput"
                    >
                      Address
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editAccountantPhoneInput"
                    >
                      Phone
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                  ...
                  <div className="text-md-center mt-2 mb-2">
                    {editIcon.icon === "" ? (
                      <label
                        ...
                        htmlFor="editAccountantIconInput"
                      >
                        Select Image
                      </label>
                    ) : (
...
export default AccountantPageRows;
