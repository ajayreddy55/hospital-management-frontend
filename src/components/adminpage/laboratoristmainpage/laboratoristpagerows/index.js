...
const LaboratoristPageRows = (props) => {
  const { eachObject, gettingLaboratoristsList } = props;
  const { name, email, address, phoneNumber, profileImage, _id } = eachObject;

  const getListAgain = () => {
    gettingLaboratoristsList();
  };
  ...
  const submitEditedInputs = async (iconImage) => {
    const url = `http://localhost:5000/api/modify-laboratorist/${_id}`;
  ...
  const deleteDetailsFromServer = async () => {
    const url = `http://localhost:5000/api/delete-laboratorist/${_id}`;
    const jwtToken = Cookies.get("hospital-jwt-token");
    const options = {
      method: "DELETE",
      headers: {
                ...
                >
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      ...
                      htmlFor="editLaboratoristNameInput"
                    >
                      Name
                    </label>
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editLaboratoristEmailInput"
                    >
                      Email
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editLaboratoristAddressInput"
                    >
                      Address
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                      <textarea
                        ...
                        id="editLaboratoristAddressInput"
                        rows={20}
                        cols={60}
                  ...
                  <div className="bayanno-admin-nplar-edit-popup-content-card-main-container mt-2 mb-2">
                    <label
                      className="bayanno-admin-nplar-edit-popup-content-card-label mr-3"
                      htmlFor="editLaboratoristPhoneInput"
                    >
                      Phone
                    </label>
                    <div className="bayanno-admin-nplar-edit-popup-content-card-input-container">
                  ...
                  <div className="text-md-center mt-2 mb-2">
                    {editIcon.icon === "" ? (
                      <label
                        ...
                        htmlFor="editLaboratoristIconInput"
                      >
                        Select Image
                      </label>
                    ) : (
...
export default LaboratoristPageRows;
